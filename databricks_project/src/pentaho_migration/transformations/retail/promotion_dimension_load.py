"""Transformation module for missing Pentaho file: Promotion_Dimension_Load.ktr
...
_LOG = get_logger("pentaho_migration.transformations.retail.promotion_dimension_load")

from pyspark.sql import types as T


SOURCE_KTR = 'Promotion_Dimension_Load.ktr'
SOURCE_MISSING = True
...
def run(spark: SparkSession, config: Mapping[str, Any] | None = None) -> DataFrame:
    ...
    return spark.createDataFrame(
        [('Promotion_Dimension_Load.ktr', config.get("RUN_ID"))],
        schema=schema,
    )
